angular.module("myApp")
    .directive('startTime', function () {//开始时间自定义指令
        return {
            restrict: 'AE',
            template: "<input type=\"text\" class=\"form-control\" name=\"start\" id=\"qBeginTime\" ng-model=\"startDate\"/>",
            controller: function () {
                //开始时间
    ...
    .directive('endTime', function () {
        return {
            restrict: "AE",
            template: "<input type=\"text\" class=\"form-control\" name=\"end\" id=\"qEndTime\" ng-model=\"endDate\"/>",
            controller: function () {
                $('#qEndTime').datepicker({
                    format: 'yyyy/mm/dd',
                    todayBtn: "linked",
