    ...
    $stateProvider.state("logIn", {
        ...
        resolve:{
            loadMyCtrl:['$ocLazyLoad',function ($ocLazyLoad) {
                return $ocLazyLoad.load(["../js/login-controller.js","../css/log-in.css"]);
            }]
        }//萝卜多后台页
    }).state("carrots", {
        url: "/carrots",
        ...
        resolve:{
            loadMyCtrl:['$ocLazyLoad',function ($ocLazyLoad) {
                return $ocLazyLoad.load(["../js/carrots-controller.js","../css/carrots.css"]);
            }]
        }//欢迎页面
        ...
        controller:'ArticleListTop',
        resolve:{
            loadMyCtrl:['$ocLazyLoad',function ($ocLazyLoad) {
                return $ocLazyLoad.load(["../js/carrots-Article-controller.js","../css/Article-list.css"]);
            }]
        }
        //新增页
        ...
        resolve:{
            loadMyCtrl:['$ocLazyLoad',function ($ocLazyLoad) {
                return $ocLazyLoad.load(["../js/carrots-Article-detail.js","../css/Article-detail.css"]);
            }]
        }
        //公司列表页
